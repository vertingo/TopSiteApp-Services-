...
/**
 * Created by VertinGo on 09/02/2018.
 */
...
public class PlaceListAdapter extends RecyclerView.Adapter<PlaceListAdapter.PlaceViewHolder> {
    ...
    public void onBindViewHolder(PlaceViewHolder holder, int position) {
        ...
        String numero = mPlaces.get(position).getPhoneNumber().toString();
        int prix = (int)mPlaces.get(position).getRating();
        String price=Integer.toString(prix);

        holder.nameTextView.setText(placeName);
        holder.addressTextView.setText(placeAddress);
        holder.numeroTextView.setText(numero);
        holder.notationTextView.setText("Notation: "+price+"/5 d'aprés les avis Google!");
    }
    ...
    class PlaceViewHolder extends RecyclerView.ViewHolder {
        ...
        public PlaceViewHolder(View itemView) {
            ...
            numeroTextView= (TextView) itemView.findViewById(R.id.numero_text_view);
            notationTextView= (TextView) itemView.findViewById(R.id.notation_text_view);
        }
