...
public class PlayerControlsDemoActivity extends YouTubeFailureRecoveryActivity implements
    ...
    private static final ListEntry[] ENTRIES = {
            ...
            new ListEntry("[Démo] Vertin Go Website sale funnel(MLM + RevShare + Solo Ad opportunities!)", "PLkVcopFUsyo4oI5J101mSqc2wgF4h_BGw", true),
            new ListEntry("[Démo et tutos] Les outils et tutoriels techniques Vertin Go Website!", "PLkVcopFUsyo7ReESgIUBCT4A7QLHeMZ3q", true),
            new ListEntry("[Démo] Les fonctionnalitées du système marketing en ligne My Power Lead System!", "PLkVcopFUsyo488EzmEwKGazh3annYKnk7",true)};
